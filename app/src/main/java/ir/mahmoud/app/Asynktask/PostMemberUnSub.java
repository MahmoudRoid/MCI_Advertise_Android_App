...
public class PostMemberUnSub {

    public Context context;
    private IWebServiceByTag delegate = null;
    private String mobileNumber,TAG;

    public PostMemberUnSub(Context context, IWebServiceByTag delegate, String mobileNumber,String TAG) {
    ...
    public void getData() {
        Call<ResponseBody> call =
                MCIApiClient.getClient().create(ApiInterface.class).memberUnSub(mobileNumber);
